    ...
    return (
      <div className="flex flex-col items-center gap-3">
        ...
        <button
          ...
          disabled={loading}
          className="flex items-center gap-2 border border-slate-300 bg-beige-200 px-4 py-2 font-ui text-sm font-medium text-slate-800 transition-colors hover:border-accent hover:bg-accent/15 disabled:opacity-60 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300"
        >
          {loading ? (
  ...
  return (
    <div className="mx-4 mb-6">
      ...
      <button
        ...
        onClick={() => inputRef.current?.click()}
        disabled={loading}
        className="flex w-full items-center justify-center gap-2 border border-slate-300 bg-beige-200 px-4 py-2 font-ui text-sm font-medium text-slate-800 transition-colors hover:border-accent hover:bg-accent/15 disabled:opacity-60 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300"
      >
        {loading ? (
